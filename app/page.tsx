		...
		<section className="max-w-[600px] lg:max-w-3xl mx-10">
			...
			<div className="flex flex-col">
				<div className="flex gap-4">
					...
					<motion.div
						className="my-4 flex flex-col gap-2 font-serif"
						initial={{ y: 0, opacity: 0 }}
						animate={{ y: 0, opacity: 1 }}
						transition={{ type: "spring", stiffness: 90, damping: 30 }}>
						<a
							href="https://github.com/kevynfg"
							target="_blank"
							className="flex flex-row items-center gap-2 transition-all hover:text-neutral-700">
							<Icon.GithubLogo
								size={26}
								weight="regular"
							/>{" "}
						...
						<a
							href="https://www.linkedin.com/in/kevynfaria/"
							target="_blank"
							className="flex flex-row items-center gap-2 transition-all hover:text-neutral-700">
							<Icon.LinkedinLogo
								size={26}
